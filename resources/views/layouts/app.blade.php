                        ...
                        @else
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                    {{-- for user profile --}}
                                    <a class="dropdown-item fa fa-btn fa-user" href="{{ route('profile') }}">{{ __('Profile') }}</a>
                                       {{-- for logout button --}}
  ...
  <div class="collapse navbar-collapse" id="navbarNav">
    <ul class="navbar-nav">
      {{-- <li class="nav-item active">
        <a class="nav-link" href="{{ route('movies.create') }}">Add new </a></li> 
        <li> --}}
        <a class="nav-link active" href="{{ route('ajax-crud.index') }}">AJAX CALL</a>
      </li>
     {{--  <li class="nav-item">
